...
# default_node_name documentation build
...
from default_node_name import __version__ as release

# -- Project information -----------------------------------------------------

project = "default_node_name"
author = "Kedro"
...
htmlhelp_basename = "default_node_namedoc"
...
latex_documents = [
    (
        master_doc,
        "default_node_name.tex",
        "default_node_name Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "default_node_name",
        "Project default_node_name codebase.",
        "Nearest-Neighbour",
    )
]
